...
<div class="container">
    <div class="card-body">
        <form action="{{ 'product'}}" class="d-flex justify-content-end" method="GET">
            @csrf
            <div class="col-md-3">
                        ...
                        @if(Auth::check())
                            @if($like_model->like_exist(Auth::user()->id,$product->id))
                                <p class="favorite-marke mr-3">
                                    <a class="js-like-toggle h1" style="text-decoration: none; color:red; cursor:pointer;" data-productid="{{ $product->id }}" >
                                        ❤
                            ...
                            @else
                            <p class="favorite-marke mr-3">
                                <a class="js-like-toggle h1" style="text-decoration: none;  color:grey; cursor:pointer;" data-productid="{{ $product->id }}">
                                    ❤
